...
int main(){
   ...
   std::map<string,myFileHanding*> diary;

   while (true)
   {
        //string buffer;
        std::cout<<"*******************************************************"<<std::endl;
        std::cout<<"Select Options"<<std::endl<<"0 for create new string"<<std::endl<<"i for insert"<<std::endl<<"u for update"<<std::endl<<"a for append"<<std::endl<<"s for search"<<std::endl<<"d for delete"<<std::endl<<"p for print data"<<std::endl<<"o for undo"<<std::endl<<"x for save"<<std::endl<<"e for exit"<<std::endl;
        std::cout<<"*******************************************************"<<std::endl;
        switch (getch())
        {
            case '0':{
                string temp;
                std::cout<<"Enter file name you want to give to the map of string"<<std::endl;
                std::cin>>temp;
                diary[temp]= new myFileHanding;
                break;
            }
            case 'i':{
                std::cout<<"Insert Mode"<<std::endl<<std::endl;
                string temp;
                std::cout<<"Enter string name"<<std::endl;
                std::cin>>temp;
                if(diary[temp]==NULL){
                    std::cout<<"String with this name is not available"<<std::endl;
                }else{
                    diary[temp]->insert();
                }
                break;
            ...
            case 's':{
                std::cout<<"search Mode"<<std::endl<<std::endl;string temp;
                std::cout<<"Enter string name"<<std::endl;
                std::cin>>temp;
                if(diary[temp]==NULL){
                    std::cout<<"String with this name is not available"<<std::endl;
                    ...
                    std::cout<<diary[temp]->search(toBeSearched)<<std::endl<<std::endl;
                }
